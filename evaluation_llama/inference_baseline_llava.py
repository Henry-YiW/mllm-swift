...
import torch
from transformers import AutoModelForCausalLM, AutoTokenizer, AutoProcessor, LlavaProcessor, LlavaForConditionalGeneration

def baseline_forward(input_ids, model, tokenizer, max_new_tokens, temperature=0.0, top_p=0.85, do_sample=False, pixel_values=None):
...
if __name__ == "__main__":
    ...
    auto_processor = LlavaProcessor.from_pretrained(args.model_path)
