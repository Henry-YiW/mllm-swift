...
MODEL_PATH=llava-hf/llava-1.5-13b-hf # Llama-2-13b-hf, CodeLlama-13b-hf, Llama-2-13b-chat-hf
MODEL_NAME=llava-1.5-13b-hf # llama-2-13b, codellama-13b, llama-2-13b-chat
...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=${GPU_DEVICES} python -m evaluation_llama.inference_baseline_llava --model-path $MODEL_PATH --model-id ${MODEL_NAME} \
